...
var canvas = createCanvas(1000,500)
   engine = Engine.create()
    ...
    box34 = new Box(812.5,150,25,25)
    box35 = new Box(837.5,150,25,25)
    box36 = new Box(862.5,150,25,25)
    box37 = new Box(887.5,150,25,25)

    box38 = new Box(825,110,25,25)
    box39 = new Box(850,110,25,25)
    box40 = new Box(875,110,25,25);
    
    box41 = new Box(837.5,70,25,25);
    box42 = new Box(862.5,70,25,25);
    
    box43= new Box(850,30,25,25);
